...
\begin{figure}[H]
 ...
 \includegraphics[width=0.5\textwidth]{graphics/fv_1_2.png}\hfill
 \includegraphics[width=0.5\textwidth]{graphics/fv_2_1.png}\hfill
\end{figure}
}
...
\item 31 is the lawest quality for smalest filesize
\end{itemize}
}
